...
export async function loginInService(formData) {
...
export async function updateCourseByIdByService(id,formData) {
...
export async function getCurrentCourseProgressService(userId, courseId) {
    ...
    const {data} = await axiosInstance.get(`/student/courses-progress/get/${userId}/${courseId}`)
...
export async function markLectureAsViewedService(userId, courseId, lectureId) {
    ...
    const {data} = await axiosInstance.post(`/student/courses-progress/mark-lecture-viewed`,{ userId, courseId, lectureId })
...
export async function resetCourseProgressService(userId, courseId) {
    ...
    const {data} = await axiosInstance.post(`/student/courses-progress/reset-progress`, {userId, courseId})
